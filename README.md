...
[本地压测报告](docs/performance/2026-07-25-local-commerce.md)
...
- **可重复压测**：异步压测脚本支持商品接口与真实Agent两种档位，统计成功率、吞吐量、平均耗时和P50/P95/P99。
...
3. 在已完成结构化日志、模型超时/重试、单机限流和基础接口压测的基础上，继续增加指标监控与小规模真实Agent并发测试；
