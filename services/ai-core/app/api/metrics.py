...
async def export_prometheus_metrics() -> PlainTextResponse:
    # Prometheus runs on the private Compose network and needs a stable,
    # non-interactive scrape endpoint. The exported series contain only
    # aggregate counters and latency values, never request bodies or secrets.
